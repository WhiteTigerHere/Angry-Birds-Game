...
public class Level3 extends Level {
    ...
    public void create(World world) {
       ...
       //  Pig
        ...
        gameObjects.add(new Block(world, 802f / GameScreen.PPM, 165f / GameScreen.PPM, 20f / GameScreen.PPM, 60f / GameScreen.PPM, Block.MaterialType.CEMENT));
        gameObjects.add(new Block(world, 474f / GameScreen.PPM, 165f / GameScreen.PPM, 20f / GameScreen.PPM, 60f / GameScreen.PPM, Block.MaterialType.CEMENT));
       ...
       // gameObjects.add(new Block(world, 478f / GameScreen.PPM, 260f / GameScreen.PPM, 30f / GameScreen.PPM, 150f / GameScreen.PPM, Block.MaterialType.WOOD));
        ...
        gameObjects.add(new Block(world, 638f / GameScreen.PPM, 231f / GameScreen.PPM, 30f / GameScreen.PPM, 50f / GameScreen.PPM, Block.MaterialType.WOOD));
        gameObjects.add(new Block(world, 638f / GameScreen.PPM, 282f / GameScreen.PPM, 30f / GameScreen.PPM, 50f / GameScreen.PPM, Block.MaterialType.WOOD));
       ...
       // gameObjects.add(new Block(world, 573f / GameScreen.PPM, 430f / GameScreen.PPM, 50f / GameScreen.PPM, 50f / GameScreen.PPM, Block.MaterialType.CEMENT));
        ...
        Bird bird2 = new Bird(world, 92.33f / GameScreen.PPM, 160.00f / GameScreen.PPM, Bird.BirdType.YELLOW);
        Bird bird3 = new Bird(world, 39.00f / GameScreen.PPM, 160.00f / GameScreen.PPM, Bird.BirdType.BLACK);
