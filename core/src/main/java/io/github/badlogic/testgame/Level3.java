...
public class Level3 extends Level {
    ...
    public void create(World world) {
       ...
       //  Pig
        gameObjects.add(new Pig(world, 720f / GameScreen.PPM, 240f / GameScreen.PPM, Pig.PigType.CORPORAL));
        gameObjects.add(new Pig(world, 638f / GameScreen.PPM, 310f / GameScreen.PPM, Pig.PigType.KING));
        gameObjects.add(new Pig(world, 570f / GameScreen.PPM, 240f / GameScreen.PPM, Pig.PigType.CLASSIC));

        // Blocks
        gameObjects.add(new Block(world, 638f / GameScreen.PPM, 135f / GameScreen.PPM, 30f / GameScreen.PPM, 60f / GameScreen.PPM, Block.MaterialType.CEMENT));
        gameObjects.add(new Block(world, 802f / GameScreen.PPM, 135f / GameScreen.PPM, 30f / GameScreen.PPM, 60f / GameScreen.PPM, Block.MaterialType.CEMENT));
        gameObjects.add(new Block(world, 474f / GameScreen.PPM, 135f / GameScreen.PPM, 30f / GameScreen.PPM, 60f / GameScreen.PPM, Block.MaterialType.CEMENT));

        gameObjects.add(new Block(world, 638f / GameScreen.PPM, 175f / GameScreen.PPM, 360f / GameScreen.PPM, 20f / GameScreen.PPM, Block.MaterialType.ICE));
       ...
       // gameObjects.add(new Block(world, 798f / GameScreen.PPM, 260f / GameScreen.PPM, 30f / GameScreen.PPM, 150f / GameScreen.PPM, Block.MaterialType.WOOD));
        gameObjects.add(new Block(world, 638f / GameScreen.PPM, 295f / GameScreen.PPM, 200f / GameScreen.PPM, 20f / GameScreen.PPM, Block.MaterialType.CEMENT));
       // gameObjects.add(new Block(world, 478f / GameScreen.PPM, 260f / GameScreen.PPM, 30f / GameScreen.PPM, 150f / GameScreen.PPM, Block.MaterialType.WOOD));
        ...
        gameObjects.add(new Block(world, 638f / GameScreen.PPM, 210f / GameScreen.PPM, 50f / GameScreen.PPM, 50f / GameScreen.PPM, Block.MaterialType.WOOD));
        gameObjects.add(new Block(world, 638f / GameScreen.PPM, 260f / GameScreen.PPM, 50f / GameScreen.PPM, 50f / GameScreen.PPM, Block.MaterialType.WOOD));
       // gameObjects.add(new Block(world, 638f / GameScreen.PPM, 310f / GameScreen.PPM, 50f / GameScreen.PPM, 50f / GameScreen.PPM, Block.MaterialType.WOOD));
        ...
        gameObjects.add(new Block(world, 723f / GameScreen.PPM, 330f / GameScreen.PPM, 50f / GameScreen.PPM, 50f / GameScreen.PPM, Block.MaterialType.WOOD));
        ...
        gameObjects.add(new Block(world, 573f / GameScreen.PPM, 330f / GameScreen.PPM, 50f / GameScreen.PPM, 50f / GameScreen.PPM, Block.MaterialType.WOOD));
